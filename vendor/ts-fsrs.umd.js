/*!
 * ts-fsrs v5.4.1 — Free Spaced Repetition Scheduler (FSRS v6)
 * https://github.com/open-spaced-repetition/ts-fsrs
 * Copyright (c) 2026 Open Spaced Repetition — MIT License
 * 许可全文见同目录 ts-fsrs.LICENSE；此文件为上游 dist/index.umd.js 原样引入（仅加本注释头）
 */
